# Generated by Powerlevel10k configuration wizard on 2025-02-25 at 14:23 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_CONTENT_EXPANSION='%d'
  ...
  typeset -g POWERLEVEL9K_VCS_DIRTY_ICON="%F{$red}*%F{$green}"
  # Show '⇣' if local branch is behind remote.
  typeset -g POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON=':⇣'
  # Show '⇡' if local branch is ahead of remote.
  typeset -g POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON=':⇡'
  # Don't show the number of commits next to the ahead/behind arrows.
  typeset -g POWERLEVEL9K_VCS_{COMMITS_AHEAD,COMMITS_BEHIND}_MAX_NUM=100
  # Remove space between '⇣' and '⇡' and all trailing spaces.
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }'
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${${${P9K_CONTENT//\%/%%}:+git:(${P9K_CONTENT})}}'
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='%B%F{242}git:%F{242}(%F{green}${P9K_CONTENT}%F{242})%f%b%F{242}'
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON=
